...
def main() -> None:
    parser = argparse.ArgumentParser(description="NorHound competition proxy v3: external intelligence is the primary differentiator.")
    ...
    report = {
        "scorer": "norhound_external_first_competition_proxy_v3",
