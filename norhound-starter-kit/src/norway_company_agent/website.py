...
USER_AGENT = "NorHound/1.0 (+https://github.com/Dhanush-sai-reddy/norhound)"
SOCIAL_HOSTS = {
...
PRIORITY_TERMS = (
    ...
    "team", "people", "karriere", "careers", "jobs", "stillinger", "ledige-stillinger", "join-us", "bli-en-av-oss",
    "locations", "lokasjoner", "avdelinger", "butikker",
